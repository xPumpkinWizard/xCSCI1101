...
plt.bar(df_follow.index - BAR_WIDTH / 0.2, df_follow["total_follows"], color = "blue", label = "Number of Follows", width = BAR_WIDTH)

plt.bar(df_hype.index + BAR_WIDTH / 0.2, df_hype["total_hypes"], color = "red", label = "Number of Hypes", width = BAR_WIDTH)
